    ...
    : QMainWindow(parent)
{
    QLabel *l=new QLabel(this);
        ...
        l->move(100,50);
        QPixmap p("C:\Users\sdeep\Desktop\image.png");
        l->setPixmap(p.scaled(20,20));

        QLabel *lb=new QLabel(this);
        lb->move(180,25);
        lb->setAlignment(Qt::AlignHCenter);
        QPixmap pi("C:\Users\sdeep\Desktop\image.png");
        ...
        QPixmap pix("C:\Users\sdeep\Desktop\password.png");
